...
- [1. The Paradigm of 3D Object Detection](#1)
    ...
    - [1.2 Camera-based 3D Object Detection](#1.1)
        - [1.1.1 Monocular 3D object detection](#1.1)
        - [1.1.2 Stereo-based 3D object detection](#1.2)
        - [1.1.3 Multi-view 3D object detection](#1.3)
    - [1.3 Multi-Modal 3D Object Detection](#1.1)
        - [1.1.1 Early-fusion based 3D object detection](#1.1)
        - [1.1.2 Intermediate-fusion based 3D object detection](#1.2)
        - [1.1.3 Late-fusion based 3D object detection](#1.3)
